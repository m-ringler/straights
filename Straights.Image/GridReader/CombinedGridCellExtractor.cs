...
public class CombinedGridCellExtractor
    : IGridCellExtractor
{
    private readonly IGridCellExtractor perspective = new PerspectiveGridCellExtractor();
    private readonly IGridCellExtractor simple = new InnerRectGridCellExtractor();
    ...
    public Mat ExtractGridCell(Mat img, SkewedGridCell cell)
    {
        ...
        bool useSimple = (outerArea - innerArea) / (outerArea + innerArea) < 0.03;
