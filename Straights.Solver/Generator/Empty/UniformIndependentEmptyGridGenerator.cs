...
internal sealed class UniformIndependentEmptyGridGenerator(GridParameters gridParameters)
    : IEmptyGridGenerator
{
    ...
    public BuilderField?[][] GenerateGrid()
    {
        ...
        foreach (var index in this.PlaceFields(nfields, [.. blackBlankLocations]))
        {
    ...
    private IEnumerable<FieldIndex> PlaceFields(int nfields, HashSet<FieldIndex>? occupied)
    {
