...
public readonly record struct UnvalidatedGridConfiguration(
    int Size,
...
)
{
    ...
    public static explicit operator GridParameters(
        UnvalidatedGridConfiguration value
    )
    {
        return new GridParameters(
            value.Size,
            value.NumberOfBlackBlanks,
            value.NumberOfBlackNumbers
        );
    }
}
