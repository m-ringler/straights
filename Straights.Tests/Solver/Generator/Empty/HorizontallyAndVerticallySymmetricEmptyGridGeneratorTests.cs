...
public class HorizontallyAndVerticallySymmetricEmptyGridGeneratorTests
{
    ...
    public void Size9_4n_plus_0_CreatesExpectedGrid()
    {
        var actual = EmptyGridGeneratorTester.GenerateBuilderText(
            (p, r) => new HorizontallyAndVerticallySymmetricEmptyGridGenerator(p) { RandomNumberGenerator = r },
...
""");
    ...
    [InlineData(2)]
    [InlineData(3)]
    public void Size8_WithWrongNumberOfBlackFields_Throws(int numberOfBlackNumbers)
    {
        Action act = () => _ = new HorizontallyAndVerticallySymmetricEmptyGridGenerator(
        ...
        ex.Message.Should().Match("The total number of black fields must be a multiple of 4 for size 8.*");
    }
}
