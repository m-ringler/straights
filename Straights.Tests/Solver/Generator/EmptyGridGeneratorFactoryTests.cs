...
public class EmptyGridGeneratorFactoryTests
{
    ...
    private readonly RandomEmptyGridGeneratorFactory sut = new(Mock.Of<IRandom>());

    [Fact]
    public void GetRandom_ReturnsExpected()
    {
        var actual = this.sut.GetRandom(this.gridParameters);
        var result = actual.Should().BeOfType<RandomEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
    ...
    public void GetUniform_ReturnsExpected()
    {
        ...
        var result = actual.Should().BeOfType<UniformEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
        result.GridParameters.Should().Be(this.gridParameters);
    }
    ...
    public void GetUniformIndependent_ReturnsExpected()
    {
        ...
        var result = actual.Should().BeOfType<UniformIndependentEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
        result.GridParameters.Should().Be(this.gridParameters);
    }
    ...
    public void GetDiagonallySymmetric_ReturnsExpected()
    {
        ...
        var result = actual.Should().BeOfType<DiagonallySymmetricEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
        result.GridParameters.Should().Be(this.gridParameters);
    }
    ...
    public void GetHorizontallySymmetric_ReturnsExpected()
    {
        ...
        var result = actual.Should().BeOfType<HorizontallySymmetricEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
        result.GridParameters.Should().Be(this.gridParameters);
    }
    ...
    public void GetVerticallySymmetric_ReturnsExpected()
    {
        ...
        var result = actual.Should().BeOfType<VerticallySymmetricEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
        result.GridParameters.Should().Be(this.gridParameters);
    }
    ...
    {
        var actual = this.sut.GetHorizontallyAndVerticallySymmetric(this.gridParameters);
        var result = actual.Should().BeOfType<HorizontallyAndVerticallySymmetricEmptyGridGenerator>().Subject;
        result.RandomNumberGenerator.Should().BeSameAs(this.sut.RandomNumberGenerator);
        result.GridParameters.Should().Be(this.gridParameters);
    }
}
